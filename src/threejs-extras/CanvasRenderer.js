...
import { RenderableFace, RenderableLine, RenderableSprite, Projector } from './Projector';
...
export function CanvasRenderer(parameters) {
  ...
  var _this = this,
    ...
    _canvas = parameters.canvas !== undefined ? parameters.canvas : createCanvas(),
  ...
  this.clear = function () {
    if (_clearBox.isEmpty() === false) {
      ...
      if (_clearAlpha > 0) {
        ...
        setFillStyle(
          'rgba(' + Math.floor(_clearColor.r * 255) + ',' + Math.floor(_clearColor.g * 255) + ',' + Math.floor(_clearColor.b * 255) + ',' + _clearAlpha + ')'
        );
